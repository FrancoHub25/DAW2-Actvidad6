...
public class ModalidadController {
	...
	@GetMapping("/porModalidadFiltroJSON")
	@ResponseBody
	public ResponseEntity<Map<String, Object>> listarPorModalidadParam(@RequestBody FiltroModalidad filtro) {
		
		Map<String, Object> salida = new HashMap<String, Object>();
		
		try {
			filtro.setNombre("%" + filtro.getNombre() + "%");
			List<Modalidad> lista = modalidadService.listaPorFiltroMod(filtro);
